...
1. **Area & Property Selection:** user selects district, property type, size, rooms.
2. **Budget Selection:** user picks a specific budget within the suggested Price Range; system looks up equivalent rent.
...
6. **Adjust:** user can change budget or area to see how the recommendation changes.
...
* **Input**
  Area/property selection, budget slider, financial profile form.
* **Decision**
